...
class CreateGroupBottomSheet : BottomSheetDialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        gradientColors.forEachIndexed { idx, (c1, c2) ->
            val swatch = View(requireContext()).apply {
                ...
                setOnClickListener {
                    ...
                    updatePreviewColor(tvPreviewEmoji, tvPreviewName)
                }
            }
        ...
        btnCrear.setOnClickListener {
            ...
            viewLifecycleOwner.lifecycleScope.launch(Dispatchers.IO) {
                try {
                    val response = RetrofitClient.api.crearGrupo(
    ...
    private fun updatePreviewColor(tvEmoji: TextView, tvName: TextView) {
        // Visual update handled by gradient background on preview card
    }
